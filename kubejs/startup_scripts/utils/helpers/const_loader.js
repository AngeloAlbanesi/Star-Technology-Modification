...
//Core Mod Loader
    ...
    global.$StarTPartAbility = $StarTPartAbility;
...
//GTCEU Loader
    ...
    // Energy Converter Loader
    const $ConverterMachine = Java.loadClass('com.gregtechceu.gtceu.common.machine.electric.ConverterMachine');
    const $FeCompat = Java.loadClass('com.gregtechceu.gtceu.api.capability.compat.FeCompat');

    // Material Properties & GTCEu API Loader
