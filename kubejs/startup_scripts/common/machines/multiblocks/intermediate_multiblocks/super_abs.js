GTCEuStartupEvents.registry('gtceu:machine', event => {
    ...
    event.create('super_abs', 'multiblock')
        ...
        .recipeModifiers([GTRecipeModifiers.PARALLEL_HATCH, GTRecipeModifiers.EBF_OVERCLOCK, $StarTRecipeModifiers.THROUGHPUT_BOOSTING, GTRecipeModifiers.BATCH_MODE])
